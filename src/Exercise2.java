    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                if (km == 0) throw new ArithmeticException("Attenzione non sono ammessi valori uguali a 0");
                ...
                if (lt == 0) throw new ArithmeticException("Attenzione non sono ammessi valori uguali a 0");
